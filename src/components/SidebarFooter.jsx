...
export default function SidebarFooter() {
  ...
  return (
    <div className="hover:bg-gray-700 hover:bg-opacity-40 w-full rounded-b-2xl p-4 mt-auto border-t border-gray-700 transition-colors duration-300 cursor-pointer hidden sm:flex">
